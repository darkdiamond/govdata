...
(`services/page_builder/cli/kimi_test.py`) against representative
...
python -m services.page_builder.cli.kimi_test --source <id> --model <model>
...
cp tmp/kimi_test/<id>/{content.html,agent_data.json,cost.json,transcript.json,preview.html} \
