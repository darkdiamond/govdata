...
# it updated AND its last analysis is older than COOLDOWN_DAYS. Enabled
# 2026-07-10 with a 90-day cooldown (quarterly refresh) — the additive-
# vs-structural concern is bounded by that cadence, not silenced.
REANALYZE_ENABLED=${REANALYZE_ENABLED:-true}
COOLDOWN_DAYS=${COOLDOWN_DAYS:-90}
